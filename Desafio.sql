...
CREATE DATABASE desafio_MatiasGonzalez056;
...
('mery@mail.com','mery','burgos','administrador'),
('matias@mail.com','matias','gonzalez','usuario'),
('benjamin@mail.com','benjamin','velasquez','usuario'),
('jaqueline@mail.com','jaqueline','gonzalez','usuario'),
('roberto@mail.com','roberto','gonzalez','usuario');
...
('prueba','contenido prueba','19/11/2022','19/11/2022',true,1),
('prueba2','contenido prueba2','20/11/2022','20/11/2022',true,1),
('ejercicios','contenido ejercicios','21/11/2022','21/11/2022',true,2),
('ejercicios2','contenido ejercicios2','22/11/2022','22/11/2022',false,2),
('random','contenido random','23/11/2022','23/11/2022',false,null);
...
post_id) VALUES 
('comentario 1','21/11/2022',1,1),
('comentario 2','21/11/2022',2,1),
('comentario 3','22/11/2022',3,1),
('comentario 4','22/11/2022',1,2);
...
SELECT posts.title AS title_post, posts.content AS content_post, comments.content AS content_comments, users.email FROM posts 
